            ...
            <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h2 className="text-xl sm:text-2xl font-black tracking-tight line-clamp-2">
                  <Link href={`/blog/${featuredPost.slug}`} className="hover:text-emerald-400 transition">
                    {featuredPost.title}
                  </Link>
                </h2>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-3 text-[11px] text-slate-400 font-medium">
                      <span className="flex items-center gap-1">
                        <Clock className="w-3.5 h-3.5 text-emerald-800 dark:text-emerald-400" />
                    ...
                    <h3 className="text-base font-extrabold line-clamp-2 group-hover:text-emerald-800 dark:group-hover:text-emerald-400 transition">
                  ...
                  <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
                    <span className="font-bold text-slate-700 dark:text-slate-300">{post.author_name}</span>
                    <Link
                      href={`/blog/${post.slug}`}
                      className="font-extrabold text-emerald-800 dark:text-emerald-400 hover:underline flex items-center gap-1"
                    >
                      <span>Lesen</span>
                      <ArrowRight className="w-3.5 h-3.5" />
                    </Link>
