  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 w-full py-8 space-y-8 text-slate-900 dark:text-white">
      ...
      <div className="text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-800 dark:text-emerald-400 text-xs font-bold">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl max-w-2xl mx-auto space-y-4">
        ...
        {/* Demo Quick Chips */}
        <div className="flex items-center gap-2 pt-2 text-[11px] text-slate-500 dark:text-slate-400 flex-wrap">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg font-mono text-emerald-800 dark:text-emerald-400 transition"
          >
            TN-DE-89230194
          </button>
          <button
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Sendungscode: <span className="font-mono text-emerald-400 font-bold">{foundOrder.tracking_number || searchedCode}</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3.5 py-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-xl text-xs font-bold text-slate-300 hover:text-white transition flex items-center gap-1.5 cursor-pointer"
                    >
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 text-xs">
                    <div className="p-3 bg-slate-900 border border-emerald-500/40 rounded-2xl space-y-1">
                      ...
                      <p className="text-[10px] text-slate-400">Bestellung erhalten</p>
                    </div>
                    ...
                    <div className="p-3 bg-slate-900 border border-emerald-500/40 rounded-2xl space-y-1">
                      ...
                      <p className="text-[10px] text-slate-400">Vorkasse SEPA validiert</p>
                    </div>
                    ...
                    <div className="p-3 bg-slate-900 border border-emerald-500/40 rounded-2xl space-y-1">
                      ...
                      <p className="text-[10px] text-slate-400">Logistik Berlin HUB</p>
                    </div>
                    ...
                    <div className="p-3 bg-slate-900 border border-emerald-600 rounded-2xl space-y-1 ring-2 ring-emerald-500/20">
                      ...
                      <p className="font-extrabold text-emerald-400 text-[11px]">4. In Zustellung</p>
                    ...
                    <div className="p-3 bg-slate-900/60 border border-slate-800 rounded-2xl space-y-1 opacity-60">
                      ...
                      <p className="font-extrabold text-slate-400 text-[11px]">5. Zugestellt</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-sm">
                  ...
                  <div className="space-y-2.5 text-xs">
                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Name &amp; Kontakt</span>
                      <p className="font-bold">{foundOrder.shipping_address?.full_name}</p>
                      <p className="text-slate-500 dark:text-slate-400 font-mono">{foundOrder.customer_email}</p>
                      <p className="text-slate-500 dark:text-slate-400 font-mono">{foundOrder.customer_phone}</p>
                    </div>

                    <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Lieferadresse (Deutschland)</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-sm">
                  ...
                  <div className="space-y-2.5 text-xs">
                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Zahlungsart</span>
                      <p className="font-bold">Vorkasse Banküberweisung (SEPA)</p>
                    </div>

                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Zahlungsstatus</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-sm">
                  ...
                  <div className="space-y-2.5 text-xs">
                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Versanddienstleister</span>
                      <p className="font-bold">DHL Express Germany (Kostenlos)</p>
                    </div>

                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Lieferzeitraum</span>
                      <p className="font-semibold text-emerald-800 dark:text-emerald-400">Heute zwischen 14:00 - 17:00 Uhr</p>
                    </div>

                    <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                      <span className="text-[10px] font-bold text-slate-400 uppercase block">Garantie &amp; Schutz</span>
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 space-y-4 shadow-sm">
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-sm font-black">
                  ...
                  <span className="text-emerald-800 dark:text-emerald-400 text-lg">{foundOrder.total_amount.toFixed(2)} €</span>
                </div>
              </div>
            </div>
          ) : (
...
export default function TrackingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/50 dark:bg-slate-950 transition-colors duration-300">
      <Header />
      <Suspense fallback={<div className="p-12 text-center text-xs text-slate-400">Sendungsverfolgung wird geladen...</div>}>
        <TrackingContent />
      </Suspense>
      <Footer />
    </div>
