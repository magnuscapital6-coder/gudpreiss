  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Approuvez, masquez ou modérez les avis déposés par les acheteurs.</p>
      </div>
          ...
          <div key={rev.id} className="py-4 flex items-start justify-between gap-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <div className="flex text-amber-700 dark:text-amber-400">
            ...
            <div className="flex items-center gap-2">
              {rev.status === 'approved' ? (
                <button
                  ...
                  className="px-3 py-1 bg-slate-900 hover:bg-slate-800 text-slate-500 dark:text-slate-400 text-xs font-bold rounded-lg border border-slate-800"
                >
                  Masquer
                </button>
              ) : (
