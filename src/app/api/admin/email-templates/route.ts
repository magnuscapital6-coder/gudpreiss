...
export async function PUT(request: NextRequest) {
  ...
  if (body.customer_template !== undefined) updatePayload.email_template_order_customer = body.customer_template;
  if (body.admin_template !== undefined) updatePayload.email_template_order_admin = body.admin_template;
  if (body.customer_subject !== undefined) updatePayload.email_subject_order_customer = body.customer_subject;
  if (body.admin_subject !== undefined) updatePayload.email_subject_order_admin = body.admin_subject;

  if (body.smtp_host !== undefined) updatePayload.smtp_host = body.smtp_host.trim();
  if (body.smtp_port !== undefined) updatePayload.smtp_port = Number(body.smtp_port) || 587;
  if (body.smtp_user !== undefined) updatePayload.smtp_user = body.smtp_user.trim();
  if (body.smtp_password !== undefined && body.smtp_password !== '********') updatePayload.smtp_password = body.smtp_password.trim();
  if (body.smtp_encryption !== undefined) updatePayload.smtp_encryption = body.smtp_encryption;
  if (body.smtp_secure !== undefined) updatePayload.smtp_secure = Boolean(body.smtp_secure);
  if (body.mail_from !== undefined) updatePayload.mail_from = body.mail_from.trim();
  if (body.mail_from_name !== undefined) updatePayload.mail_from_name = body.mail_from_name.trim();
  if (body.resend_api_key !== undefined) updatePayload.resend_api_key = body.resend_api_key.trim();
  if (body.admin_notification_email !== undefined) updatePayload.admin_notification_email = body.admin_notification_email.trim();
