            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-800 mb-1">Ihr Name</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-800 mb-1">Betreff</label>
                  <input type="text" required className="w-full px-4 py-2.5 text-xs border border-slate-200 rounded-xl outline-none" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-800 mb-1">Nachricht</label>
