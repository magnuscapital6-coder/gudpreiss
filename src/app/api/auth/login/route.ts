...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!supabaseUrl || !supabaseKey) {
      console.error('[AUTH_LOGIN] Supabase not configured. URL:', !!process.env.NEXT_PUBLIC_SUPABASE_URL, !!process.env.SUPABASE_URL, 'Key:', !!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, !!process.env.SUPABASE_ANON_KEY);
      return NextResponse.json(
